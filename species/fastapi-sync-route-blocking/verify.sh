#!/bin/sh
# fastapi-sync-route-blocking verifier (Sprint 024 Python/FastAPI wave, command:
...
# this proves every Python file STILL PARSES after the route was rewritten async —
